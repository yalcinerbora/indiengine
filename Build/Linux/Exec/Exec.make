...
PROJECT_DEPENDENCIES = IESystem IEUtility IEInputLINUX
...
PROJECT_DEBUG_COMMAND = $(ARCHIVE) cr $(IE_DEBUG_FOLDER)/$(PROJECT_OUTPUT) $?
PROJECT_RELEASE_COMMAND = $(ARCHIVE) cr $(IE_RELEASE_FOLDER)/$(PROJECT_OUTPUT) $?
